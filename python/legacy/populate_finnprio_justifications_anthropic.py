...
def copy_database(source_path: str, output_dir: str) -> str:
    ...
    # Check if source already has _anthropic_ pattern - extract base name
    if "_anthropic_" in original_name:
        base_name = original_name.split("_anthropic_")[0]
    elif "_ai_enhanced_" in original_name:
        base_name = original_name.split("_ai_enhanced_")[0]
    else:
        base_name = original_name

    output_name = f"{base_name}_anthropic_{timestamp}.db"

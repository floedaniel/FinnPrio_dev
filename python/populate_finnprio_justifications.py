...
def _get_hardcoded_instructions(question_code: str, pest_name: str,
    ...
    if pathway_name:
        pathway_context = f' via the pathway "{pathway_name}"'
        return f"""
Answer ONLY about {pest_name} transport/survival{pathway_context}.
...
DO NOT include pathways, transport, entry mechanisms, or management.""",
...
DO NOT include climate (EST1), spread (EST3), or characteristics (EST4).""",
        ...
        'EST3.': f"""
Answer ONLY about spread rate of {pest_name} in Norway.
...
DO NOT include control costs, indirect impacts, or environmental/social impacts.""",
...
DO NOT include eradication or detection during imports.""",
    }
